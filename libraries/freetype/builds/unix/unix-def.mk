...
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -lpng16 -lm -lm -lz -lharfbuzz -lm -lglib-2.0 -lm -pthread -lsysprof-capture-4 -pthread -lpcre2-8 -lfreetype -lz -lbz2 -lpng16 -lm -lm -lz -lbrotlidec -lbrotlicommon -lgraphite2 -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 25.0.19
